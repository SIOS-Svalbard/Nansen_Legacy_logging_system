...
from website.database.get_data import get_data, get_personnel_df, get_samples_for_pi, get_samples_for_recordedby, get_samples_for_personnel, get_samples_for_sampletype
...
from . import DBNAME, METADATA_CATALOGUE, CRUISE_NUMBER, CRUISE_DETAILS_TABLE
...
def export_data():
    ...
    personnel_df = get_personnel_df(DBNAME=DBNAME, table='personnel')
    ...
    if request.method == 'POST':
        ...
        if form_input['selection'] == ['pi']:
            ...
            df_to_export = get_samples_for_pi(DBNAME, METADATA_CATALOGUE, pi_email)
        ...
        if form_input['selection'] == ['recordedby']:
            ...
            df_to_export = get_samples_for_recordedby(DBNAME, METADATA_CATALOGUE, recordedby_email)
        ...
        if form_input['selection'] == ['piorrecordedby']:
            ...
            df_to_export = get_samples_for_personnel(DBNAME, METADATA_CATALOGUE, personnel_email)
        ...
        if form_input['selection'] == ['sampleType']:
            ...
            df_to_export = get_samples_for_sampletype(DBNAME, METADATA_CATALOGUE, sampletype)
